...
export const blacklistedDomains: readonly string[] = Object.freeze([
  '0-00.usa.cc',
  '0-attorney.com',
  '0-mail.com',
  '00.msk.ru',
...
export const BLACKLISTED_DOMAINS: ReadonlySet<string> = Object.freeze(
  new Set(blacklistedDomains)
);

export const BLACKLIST_COUNT = blacklistedDomains.length;
